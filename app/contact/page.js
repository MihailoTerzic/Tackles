    ...
    <div className="text-black">
      ...
      <section className="bg-white py-20 px-6 md:px-12">
        ...
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-16 justify-between"> 
          {/* Info Block */}
          <div className="flex flex-col w-full lg:w-1/2 bg-gray-100 p-5 rounded-2xl">
            <div className="mb-10">
          ...
          {/* Contact Form */}
          <form className="flex flex-col w-full lg:w-1/2 max-w-lg p-5 space-y-6 justify-between">
            <div className="space-y-1">
            ...
            <button
              type="submit"
              className="w-full bg-[#008000] hover:scale-105 hover:font-bold text-white py-3 rounded-lg hover:bg-[#008000] transition mt-auto"
            >
              Submit
            </button>
          </form>
